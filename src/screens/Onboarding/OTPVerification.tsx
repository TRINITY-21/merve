...
import {
  Animated,
  Dimensions,
  // Keyboard, // No longer strictly needed if not adding custom listeners
  Platform,
  // ScrollView, // REMOVE THIS IMPORT
  TextInput,
  TouchableOpacity,
  Vibration,
  View,
...
return (
  ...
  >
    {/* All content that was inside the ScrollView goes directly here */}
    <View style={{ flex: 1 }}> {/* Keep this flex 1 View */}
        {/* Header content below main title */}
        <View style={{
          flexDirection: 'row',
          alignItems: 'flex-start',
          justifyContent: 'space-between',
          paddingHorizontal: 0, // BottomSheet's contentStyle will handle horizontal padding
          paddingTop: 0,
          paddingBottom: 16,
        }}>
          <View style={{ flex: 1 }}>
        ...
        {/* The content that was previously wrapped in OTPVerification's ScrollView */}
        {/* Keep the paddingTop for content that starts below the header description */}
        <View style={{ flex: 1, paddingTop: 32, paddingBottom: Platform.OS === 'ios' ? 0 : 20 }}>
            {/* OTP Icon */}
            <View style={{
              alignItems: 'center',
              marginBottom: 24,
