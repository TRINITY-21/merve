...
import { IAgent, IChatScreenProps, IMediaAttachment, IMessage, IReplyTo, IUser } from '../../../types/chatTypes';
import { ChatInput, MessageItem, QuickReplies, ReplyPreview } from './components';
...
const ChatScreen: React.FC<IChatScreenProps> = ({ route }) => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FFCC00]">
