    ...
    ({
        ...
        const getSheetHeight = (): number => {
            ...
            if (typeof height === 'string') {
                ...
                calculatedHeight = (SCREEN_HEIGHT * percentage) / 100;
            } else {
            ...
            if (keyboardVisible && androidKeyboardAvoid) {
                ...
                const safeAreaTop = Platform.OS === 'ios' ? 44 : 10; // Approximate iOS safe area top
                const availableHeight = SCREEN_HEIGHT - statusBarHeight - safeAreaTop - keyboardHeight;
                    ...
                    contentContainerStyle={[
                        {
                            ...
                            paddingHorizontal: 20,
                            paddingTop: 10,
                            paddingBottom: keyboardVisible ? Math.max(keyboardHeight + 20, 0) : 60,
                        },
                        contentStyle,
                    ]} 
                         resetScrollToCoords={{ x: 0, y: 0 }}
                         enableAutomaticScroll={true}
                         extraHeight={Platform.OS === 'ios' ? 0 : 0} // Adjust extra height for iOS/Android
                         extraScrollHeight={Platform.OS === 'ios' ? 10 : 0} // Adjust extra scroll height
